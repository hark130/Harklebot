...
################################################
### URL SETUP ###
webComicName = 'Awkward_Zombie' # <=--------------------------=UPDATE=--------------------------=>
baseURL = 'http://www.awkwardzombie.com/' # <=--------------------------=UPDATE=--------------------------=>
...
imageSearchPhrase = ['s3.amazonaws.com/AZComics/','photobucket.com/albums/f278/katietiedrich/'] # <=--------------------------=UPDATE=--------------------------=>
...
firstSearchPhrase = 'First Comic' # Probably 'First' <=--------------------------=UPDATE=--------------------------=>
...
nameSearchPhrase = 'document.title + " - " + "' # Probably 'alt="' <=--------------------------=UPDATE=--------------------------=>
