...
################################################
### URL SETUP ###
webComicName = 'Awkward_Zombie'
baseURL = 'http://www.awkwardzombie.com/'
targetComicURL = baseURL # Original source
#targetComicURL = 'http://awkwardzombie.com/index.php?page=0&comic=092006' # Start here instead

### IMAGE URL SETUP ###
imageSearchPhrase = ['s3.amazonaws.com/AZComics/','photobucket.com/albums/f278/katietiedrich/']  # Find the appropriate HTML line from a list of strings
imageBeginPhrase = 'src="'  # Find the beginning of the image reference

### PREV URL SETUP ###
prevSearchPhrase = 'Previous Comic'

### FIRST URL SETUP ###
firstSearchPhrase = 'First Comic'
...
### NAME PARSING SETUP ###
nameSearchPhrase = 'document.title + " - " + "'
nameEnding = '"'
################################################
################################################
################################################
...
num404Skips = 0             # Variable to store the number of missing webpageds
#########################
#########################
#########################
...
#        print("Filename:\t{}".format(incomingFilename)) # DEBUGGING
    ...
    if currentURL == firstURL:                   # dynamically read First
        ...
        print("Missing First URL.  We must be there.\nCurrent URL:\t{}\nFirst URL:\t{}\n".format(currentURL,firstURL))
        break
