...
################################################
### URL SETUP ###
webComicName = 'Order_of_the_Stick' # <=--------------------------=UPDATE=--------------------------=>
baseURL = 'http://www.giantitp.com' # <=--------------------------=UPDATE=--------------------------=>
targetComicURL = 'http://www.giantitp.com/Comics.html' # Original source
#targetComicURL = 'http://www.giantitp.com/Comics.html' # Start here instead

### IMAGE URL SETUP ###
# Find the appropriate HTML line from a list of strings
imageSearchPhrase = ['src="/comics/images/'] # <=--------------------------=UPDATE=--------------------------=>
...
latestSearchPhrase = 'Order of the Stick' # Probably 'Last' <=--------------------------=UPDATE=--------------------------=>

### PREV URL SETUP ###
# Find the 'name' of the obligatory 'Previous Comic' navigation button
prevSearchPhrase = 'title="Previous Comic"' # Probably 'Prev' <=--------------------------=UPDATE=--------------------------=>
...
firstSearchPhrase = 'title="First Comic"' # Probably 'First' <=--------------------------=UPDATE=--------------------------=>
...
nameSearchPhrase = 'oots' # Probably 'alt="' <=--------------------------=UPDATE=--------------------------=>
# Delimit the end of the image title with this string
nameEnding = '.htm' # Probably '"' <=--------------------------=UPDATE=--------------------------=>
################################################
...
#        comicHTML = comicContentDecoded.split('\n') # No longer necessary in Version 1-2
        comicContentDecoded = currentURL + '\n' + comicContentDecoded # Sometimes, the name and/or date is in the URL
        pass
