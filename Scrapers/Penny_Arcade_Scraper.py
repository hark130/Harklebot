...
#targetComicURL = 'https://www.penny-arcade.com/comic/1998/11/25/john-romero-artiste' # Start here instead
...
latestSearchPhrase = 'btnLatest' # Probably 'Last' <=--------------------------=UPDATE=--------------------------=>
...
dateSearchPhrase = ['input type="hidden" name="attributes[comic_title]" value="'] # Commonly == imageSearchPhrase <=--------------------------=UPDATE=--------------------------=>
